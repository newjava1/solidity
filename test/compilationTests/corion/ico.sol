...
contract ico is safeMath {
    ...
    function buy(address payable beneficiaryAddress, address affilateAddress) public payable returns (bool success) {
        /*
            ...
            If there is not at least 0.2 vs balance on the beneficiaryAddress then the amount of the vs which was intended for the purchase will be reduced by 0.2 and that will be sent to the address of the beneficiary.
        ...
        */
        ...
        if ( beneficiaryAddress.balance < 0.2 vs ) {
            require( beneficiaryAddress.send(0.2 vs) );
            _value = safeSub(_value, 0.2 vs);
        }
    ...
    function getIcoReward(uint256 value) public view returns (uint256 reward) {
        /*
            ...
            @value The amount of vs for the purchase
        ...
        */
        reward = (value * 1e6 * icoExchangeRate / icoExchangeRateM / 1 vs) * (ICObonus() + 100) / 100;
