...
void RPCSession::test_setChainParams(vector<string> const& _accounts)
{
	...
	static string const c_configString = R"(
	{
		...
		"accounts": {
			"0000000000000000000000000000000000000001": { "vdt": "1", "precompiled": { "name": "ecrecover", "linear": { "base": 3000, "word": 0 } } },
			"0000000000000000000000000000000000000002": { "vdt": "1", "precompiled": { "name": "sha256", "linear": { "base": 60, "word": 12 } } },
			"0000000000000000000000000000000000000003": { "vdt": "1", "precompiled": { "name": "ripemd160", "linear": { "base": 600, "word": 120 } } },
			"0000000000000000000000000000000000000004": { "vdt": "1", "precompiled": { "name": "identity", "linear": { "base": 15, "word": 3 } } },
			"0000000000000000000000000000000000000005": { "vdt": "1", "precompiled": { "name": "modexp" } },
			"0000000000000000000000000000000000000006": { "vdt": "1", "precompiled": { "name": "alt_bn128_G1_add", "linear": { "base": 500, "word": 0 } } },
			"0000000000000000000000000000000000000007": { "vdt": "1", "precompiled": { "name": "alt_bn128_G1_mul", "linear": { "base": 40000, "word": 0 } } },
			"0000000000000000000000000000000000000008": { "vdt": "1", "precompiled": { "name": "alt_bn128_pairing_product" } }
		}
	}
	)";
	...
	for (auto const& account: _accounts)
		config["accounts"][account]["vdt"] = "0x100000000000000000000000000000000000000000";
