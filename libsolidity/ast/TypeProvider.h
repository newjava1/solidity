...
public:
	...
	{
		solAssert((_bits % 8) == 0, "");
		if (_modifier == IntegerType::Modifier::VrcToken)
			return &m_vrcToken;
	...
	static IntegerType const* vrcToken() { return integer(256, IntegerType::Modifier::VrcToken); }
...
private:
	...
	static IntegerType const m_vrcToken;
