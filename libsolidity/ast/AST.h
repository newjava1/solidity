 ...
 */
    ...
    public:
      ...
      Declaration(
          ...
          Visibility _visibility = Visibility::Default) : ASTNode(_location), m_name(_name), m_visibility(_visibility) {}
 ...
 */
    ...
    public:
      InheritanceSpecifier(
          ...
          std::unique_ptr<std::vector<ASTPointer<Expression>>> _arguments) : ASTNode(_location), m_baseName(_baseName), m_arguments(std::move(_arguments)) {}
 ...
 */
    ...
    public:
      ...
      VariableDeclaration(
          ...
          Location _referenceLocation = Location::Unspecified) : Declaration(_sourceLocation, _name, _visibility),
                                                                 m_typeName(_type),
                                                                 m_value(_value),
 ...
 */
    ...
    public:
      ModifierInvocation(
          ...
          std::unique_ptr<std::vector<ASTPointer<Expression>>> _arguments) : ASTNode(_location), m_modifierName(_name), m_arguments(std::move(_arguments)) {}
 ...
 */
    ...
    {
    public:
      MagicVariableDeclaration(ASTString const &_name, Type const *_type) : Declaration(SourceLocation(), std::make_shared<ASTString>(_name)), m_type(_type) {}
 ...
 */
    ...
    public:
      ElementaryTypeName(
          ...
          boost::optional<StateMutability> _stateMutability = {}) : TypeName(_location), m_type(_elem), m_stateMutability(_stateMutability)
      {
 ...
 */
    ...
    public:
      InlineAssembly(
          ...
          std::shared_ptr<yul::Block> const &_operations) : Statement(_location, _docString), m_dialect(_dialect), m_operations(_operations) {}
      void accept(ASTVisitor &_visitor) override;
      void accept(ASTConstVisitor &_visitor) const override;
 ...
 */
    ...
    public:
      explicit EmitStatement(
          SourceLocation const &_location,
          ASTPointer<ASTString> const &_docString,
          ASTPointer<FunctionCall> const &_functionCall) : Statement(_location, _docString), m_eventCall(_functionCall) {}
      void accept(ASTVisitor &_visitor) override;
      void accept(ASTConstVisitor &_visitor) const override;
 ...
 */
    ...
    public:
      enum class SubDenomination
      {
        ...
        Vdt = static_cast<int>(Token::SubVdt),
        Vs = static_cast<int>(Token::SubVs),
